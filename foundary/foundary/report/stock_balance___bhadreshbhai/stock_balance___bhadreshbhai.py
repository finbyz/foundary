...
class StockBalanceReport:
    ...
    def prepare_new_data(self):
        ...
        # Get items weights
        item_weights = self.get_item_weights()
    ...
    def get_item_weights(self):
        """Fetch weight per unit and weight UOM for all items in the report"""
        item_codes = list(set(entry[1] for entry in self.item_warehouse_map.keys()))
    ...
    def get_columns(self):
        ...
        columns.extend(
            [
                ...
                {
                    "label": _("Weight per Unit"),  # New column added
                    "fieldname": "weight_per_unit",
                    "fieldtype": "Float",
                    "width": 100,
                },
                {
                    "label": _("Total Weight"),  # New column added
